...
The "what" dimension of a hypercert, meaning the work being claimed. Can be a simple text description or a structured [CEL expression](https://github.com/google/cel-spec) for machine-evaluable scopes. See [Describing and Classifying Work](/core-concepts/cel-work-scopes).
