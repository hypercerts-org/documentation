...
This guide walks through creating a complete hypercert using TypeScript and Node.js v20+. Prefer a UI? See [Using the UI](/getting-started/using-the-scaffold-app).
