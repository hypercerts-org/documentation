...
description: How ATProto enables data migration, app switching, and network-wide scaling.
---
...
- [Account & Identity Setup](/architecture/account-and-identity) — DID-based identity and authentication
- [Why AT Protocol?](/core-concepts/why-at-protocol) — why ATProto was chosen for the data layer
