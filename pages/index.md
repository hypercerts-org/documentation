...
{% /card-link %}
{% card-link title="Common Use Cases" href="/core-concepts/common-use-cases" icon="<svg viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25\"/></svg>" %}
Worked examples for open-source, climate, research, and community projects
{% /card-link %}
{% card-link title="Building on Hypercerts" href="/getting-started/building-on-hypercerts" icon="<svg viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M11.42 15.17l-5.384 3.161 1.028-5.995L2.28 7.823l6.02-.874L11.42 1.5l2.692 5.449 6.02.874-4.784 4.513 1.028 5.995-5.384-3.161z\"/></svg>" %}
Integration patterns for platforms and tools that want to build on the protocol
{% /card-link %}
{% card-link title="Testing & Deployment" href="/getting-started/testing-and-deployment" icon="<svg viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0112 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5\"/></svg>" %}
Test your integration, understand record constraints, and go live
{% /card-link %}
{% /card-grid %}
...
How identity works in the Hypercerts ecosystem — DIDs, signing, portability, and wallet linkage
{% /card-link %}
{% card-link title="Why AT Protocol?" href="/core-concepts/why-at-protocol" icon="<svg viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418\"/></svg>" %}
Why the Hypercerts Protocol is built on AT Protocol
{% /card-link %}
{% card-link title="Funding & Value Flow" href="/core-concepts/funding-and-value-flow" icon="<svg viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z\"/></svg>" %}
How hypercerts track funding of activities and optionally wrap claims in onchain tokens
{% /card-link %}
{% /card-grid %}
...
{% /card-link %}
{% card-link title="Account & Identity Setup" href="/architecture/account-and-identity" icon="<svg viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5zm6-10.125a1.875 1.875 0 11-3.75 0 1.875 1.875 0 013.75 0zm-3.375 6.375h4.5c.621 0 1.125-.504 1.125-1.125a3 3 0 00-6.75 0c0 .621.504 1.125 1.125 1.125z\"/></svg>" %}
Understand your identity, configure custom domains, and manage credentials
{% /card-link %}
...
{% /card-link %}
{% card-link title="Indexers & Discovery" href="/architecture/indexers-and-discovery" icon="<svg viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z\"/></svg>" %}
How indexers make hypercerts findable across the network
{% /card-link %}
{% card-link title="Portability & Data Access" href="/architecture/portability-and-scaling" icon="<svg viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5\"/></svg>" %}
...
Recognizing and rewarding value creators
{% /card-link %}
{% /card-grid %}
