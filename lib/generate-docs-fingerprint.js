 ...
 * 3. Each source fingerprint includes its registry identity, SHA-256 content hash, and any tracked published release.
...
async function getSnapshots(contentPath) {
  ...
  return collectExternalDocSnapshots(sources, getGitHubToken());
}
