export const navigation = [
  {
    section: "Guide",
    children: [
      { title: "Guide overview", path: "/guide" },
      {
        title: "Foundations",
        children: [
          {
      ...
      },
      {
        ...
        children: [
          ...
          {
            title: "Work Scopes & Classification",
            path: "/core-concepts/cel-work-scopes",
          },
          {
            title: "Funding Records & Value Flow",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            path: "/core-concepts/validation-and-interpretation",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    children: [
      { title: "Change history overview", path: "/change-history" },
      { title: "Lexicon Releases", path: "/reference/releases" },
    ],
  },
];
