...
function externalDocsLoader(source) {
  ...
  if (!Object.prototype.hasOwnProperty.call(frontmatter, 'externalDoc')) {
    if (/^{% (release-latest|release-summary|release-cards|protocol-history) \/%}$/m.test(source)) {
      this.addDependency(CONTENT_PATH);
      return resolvePageDocument(frontmatter, source, loadExternalDocsContent(), this.resourcePath).markdown;
    }
    return source;
  }
