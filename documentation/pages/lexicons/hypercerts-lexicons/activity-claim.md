...
| `workScope`        | `object` | ❌ | Logical scope of the work using label-based conditions. See [work scope](/getting-started/the-impact-and-work-space) for more information. | Object with `allOf`, `anyOf`, `noneOf` arrays of labels        |
