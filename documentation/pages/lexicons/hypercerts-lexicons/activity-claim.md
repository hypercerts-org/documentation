...
| `workScope`        | `object` | ❌ | Logical scope of the work using label-based conditions. See [Defining Work Scopes](/getting-started/defining-work-scopes) for details. | Object with `allOf`, `anyOf`, `noneOf` arrays of labels        |
