...
If you don't want to run your own instance, you can point your staging environment at [`dev.certified.app`](/reference/certified-services) — the Certified-operated staging ePDS. It's the usual target for app developers building on Hypercerts who want to offer "Sign in with Certified". See [Certified PDSs](/reference/certified-services) for the caveats that apply.
